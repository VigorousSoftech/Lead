...
- (void)buttonClicked:(id)sender
{
    ...
    if (delegate != nil && [self.delegate respondsToSelector:@selector(alertView:Buttonclick:)]) {
        [delegate alertView:self Buttonclick:buttonIndex];
    }
...
-(NSString *)buttonTitleAtIndex:(NSInteger)index
{
    ...
    UIButton *btn= (UIButton*)[_view viewWithTag:index+1];
    NSString *title=[btn.titleLabel.text copy];
    return title;
}
